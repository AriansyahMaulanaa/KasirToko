...
public class FormPelanggan extends javax.swing.JFrame {
    ...
    private void buatTampilan() {
        ...
        getContentPane().add(UiStyle.header("Master Data Pelanggan", "Nama, telepon, dan alamat pelanggan"), BorderLayout.NORTH);
        getContentPane().add(konten, BorderLayout.CENTER);
        getContentPane().add(tombol, BorderLayout.SOUTH);

        btnSimpan.addActionListener(e -> {
            try {
                Koneksi.tambahPelanggan(new Pelanggan(
        ...
        btnHapus.addActionListener(e -> {
            ...
            if (baris >= 0) {
                try {
                    Koneksi.hapusPelanggan(new Pelanggan(
    ...
    private void tampilData() {
        try {
            model.setRowCount(0);
            for (Pelanggan pelanggan : Koneksi.getPelanggan()) {
