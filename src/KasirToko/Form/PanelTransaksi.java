...
public class PanelTransaksi extends JPanel {
    ...
    public PanelTransaksi(boolean tampilHeader) {
        buatTampilan(tampilHeader);
    }

    private void buatTampilan(boolean tampilHeader) {
        setLayout(new BorderLayout());
        setBackground(UiStyle.PAGE);
        ...
        if (tampilHeader) {
            add(UiStyle.header("Transaksi Penjualan", "Input barang, hitung total, simpan transaksi, dan lihat struk"), BorderLayout.NORTH);
        }
